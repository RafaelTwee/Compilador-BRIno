...
public class BrinoLexerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PORTA", "IMPORTAR", "MODOPINO", "REPETIR", "LERANALOG", "ESCREVERANALOG", 
			...
			"OP_ARIT", "OP_ARIT2", "VARIAVEL", "ESC_SEQ", "VIRGULA", "ATRIB", "ABREPAR", 
			"FECHAPAR", "ABRECHAVE", "FECHACHAVE", "COMENTARIO", "EB"
		};
	}
	...
	public BrinoLexerLexer(CharStream input) {
		super(input);
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		...
		case 37:
			...
			break;
		case 38:
			EB_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	...
	private void EB_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 1:
			skip();
			break;
